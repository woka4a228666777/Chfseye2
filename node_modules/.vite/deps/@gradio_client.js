...
var D = "Could not resolve app config. ";
var it = "Could not get space status. ";
var ot = "Could not get API info. ";
...
async function ve(e, s) {
  ...
  if ((e == null ? void 0 : e.status) === 200) {
    let t = await e.json();
    return (_c = t.dependencies) == null ? void 0 : _c.forEach((n, i) => {
      n.id === void 0 && (n.id = i);
    }), t;
  ...
  return Object.keys(e).forEach((i) => {
    (i === "named_endpoints" || i === "unnamed_endpoints") && (n[i] = {}, Object.entries(e[i]).forEach(
      ([r, { parameters: o, returns: a }]) => {
        ...
        if (u !== -1 && ((_d = (_c = s.dependencies.find((c) => c.id == u)) == null ? void 0 : _c.inputs) == null ? void 0 : _d.length) !== o.length) {
        ...
        const p = (c, m, w, N) => ({
          ...
          type: mt(c == null ? void 0 : c.type, m, w, N) || ""
        });
        n[i][r] = {
          parameters: o.map(
...
async function ce(e, s = void 0, t = [], n = false, i = void 0) {
  if (Array.isArray(e)) {
    let r = [];
    return await Promise.all(
      e.map(async (o, a) => {
        ...
        const l = await ce(
          e[a],
          n ? ((_a = i == null ? void 0 : i.parameters[a]) == null ? void 0 : _a.component) || void 0 : s,
          u,
          false,
          i
        );
...
async function Ct(e, s, t) {
  var _a, _b;
  let n = s[t];
  const i = ((_a = e.config) == null ? void 0 : _a.root) || ((_b = e.config) == null ? void 0 : _b.root_url);
  if (!i)
    throw new Error(Ce);
  try {
    let r, o;
    if (typeof process < "u" && process.versions && process.versions.node) {
      const p = await import("./__vite-browser-external-DYxpcVy9-FPQFRM6H.js");
      o = (await import("./__vite-browser-external-DYxpcVy9-FPQFRM6H.js")).resolve(process.cwd(), n.meta.path), r = await p.readFile(o);
    } else
      throw new Error(ut);
    const a = new Blob([r], {
...
async function* Ft(e, s) {
  ...
  for (; ; ) {
    ...
    let [o, a] = Bt(n.value) || [];
    o === "data" ? (r || (r = {}), r[o] = r[o] ? r[o] + `
` + a : a) : o === "event" ? (r || (r = {}), r[o] = a) : o === "id" ? (r || (r = {}), r[o] = String(+a) === a ? +a : a) : o === "retry" && (r || (r = {}), r[o] = +a || void 0);
  }
}
...
function Kt(e, s = {}, t, n, i, r) {
  ...
  try {
    ...
    let W, b = null, T = false, _e2 = {}, B = typeof window < "u" && typeof document < "u" ? new URLSearchParams(window.location.search).toString() : "";
    const ze = ((_a = J == null ? void 0 : J.events) == null ? void 0 : _a.reduce(
      (h, k) => (h[k] = true, h),
      {}
    )) || {};
    async function Be() {
        ...
        j.onmessage = async function(v) {
          ...
          if (P === "update" && A && !T)
            o({
              ...
              time: /* @__PURE__ */ new Date(),
              ...A
            }), A.stage === "error" && (j == null ? void 0 : j.close(), a());
          else if (P === "data") {
            let [C, I] = await ne(
              `${f.root}${R}/queue/data`,
              {
            ...
            let we = async function(oe) {
              try {
                ...
                $ && (o({
                  ...
                  endpoint: _,
                  fn_index: d
                }), a())), ((S == null ? void 0 : S.stage) === "complete" || (S == null ? void 0 : S.stage) === "error") && (se[b] && delete se[b], b in te && delete te[b]);
              } catch (E) {
