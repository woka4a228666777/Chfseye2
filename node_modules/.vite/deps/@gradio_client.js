...
async function Ct(e, s, t) {
  ...
  try {
    ...
    if (typeof process < "u" && process.versions && process.versions.node) {
      const p = await import("./__vite-browser-external-DYxpcVy9-A6AMU5UU.js");
      o = (await import("./__vite-browser-external-DYxpcVy9-A6AMU5UU.js")).resolve(process.cwd(), n.meta.path), r = await p.readFile(o);
    } else
      throw new Error(ut);
    const a = new Blob([r], {
